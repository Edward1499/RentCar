        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CRExpiration = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CRCCVNumber = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PersonalNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BatchWork = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountDay = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasHydraulicJack = table.Column<bool>(type: "bit", nullable: false),
                    HasGlassBreak = table.Column<bool>(type: "bit", nullable: false),
                    IsRightFrontTireOk = table.Column<bool>(type: "bit", nullable: false),
                    IsLeftFrontTireOk = table.Column<bool>(type: "bit", nullable: false),
                    IsRightRearTireOk = table.Column<bool>(type: "bit", nullable: false),
                    IsLeftRearTireOk = table.Column<bool>(type: "bit", nullable: false),
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
